<div class="page-header">
	...
	<div class="page-header-top">
	    <div class="container">
	        ...
	        <div class="page-logo">
	            <a href="index.html">
	                <img src="<?= $baseUrl; ?>/assets/layouts/layout3/img/logo-default.jpg" alt="logo" class="logo-default">
	            </a>
	        </div>
	        <!-- END LOGO -->
	        ...
	        <div class="top-menu">
	            <ul class="nav navbar-nav pull-right">
	                ...
	                <li class="dropdown dropdown-user dropdown-dark">
	                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
	                        <img alt="" class="img-circle" src="<?= $baseUrl; ?>/assets/layouts/layout3/img/avatar9.jpg">
