var Login = function() {
 ...
 return {
  init: function() {
   r(), $(".login-bg").backstretch(["../themes/metronic/assets/pages/img/login/1.jpg", "../themes/metronic/assets/pages/img/login/2.jpg", "../themes/metronic/assets/pages/img/login/3.jpg"], {
    fade: 1e3,
    duration: 8e3
   }), $(".forget-form").hide()
  }
