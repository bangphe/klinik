    ...
    <div class="col-md-8">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-envelope"></i>Form Kirim SMS Pelanggan
                </div>
                <div class="tools"></div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo $form->dropDownList($model, 'TUJUAN', Pasien::model()->ListPasienSMS(), array('class' => 'form-control', 'multiple' => "multiple")); ?>
