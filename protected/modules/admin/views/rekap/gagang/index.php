        ...
        <div class="portlet light bg-inverse">
            <div class="portlet-title">
                <div class="caption font-green-sharp">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Rekap Laporan Gagang</span>
                </div>
                <div class="actions">
                    <?php echo CHtml::link('<i class="fa fa-print"></i> Rekap Laporan Bulanan', array('/admin/rekap/penjualangagang'),array('class' => 'btn red')) ?>
                </div>
            </div>
