<table border="1">
    <tr>
    <th colspan="10">KLINIK AR-RAHMAH | Rekap Transaksi Harian <?= MyFormatter::formatTanggal(date('Y-m-d')); ?></th>
    </tr>
    <tr>
        <th>NO NOTA</th>
        <th>TANGGAL ORDER</th>
        ...
        <tr>
            ...
            <td>
                <?php foreach ($data->orderdetail as $value) { ?>
                    <?php if ($value->item->ID_KATEGORI=='1') { ?>
    ...
    <?php endforeach ?>
    <tr>
        <th colspan="10">TOTAL TRANSAKSI HARI INI</th>
