...
<tr>
    ...
    <td><?php echo MyFormatter::formatUang($data->getTotal()); ?></td>
    <td width="8%">
        ...
        <?php echo CHtml::link('<i class="fa fa-trash-o"></i> Hapus',array('/order/delete/','id'=>$data->KODE_ORDER),array('class'=>'btn btn-sm red filter-cancel','submit'=>array('delete','id'=>$data->KODE_ORDER),'confirm'=>'Apakah Anda yakin akan menghapus Invoice #'.$data->KODE_ORDER.'?')); ?>
    </td>
</tr>